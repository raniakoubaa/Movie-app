...
function App() {
  ...
  return (
    <div className='App'>
      ...
      <Router>
        <Switch>
        <Route  path='/' exact render={()=><Home ListM={ListM} handlDelete={handlDelete}/>}/>
        <Route path='/descrip' exact render={<MovieDesc list={ListM}/>}/>
        <Route path="/MovieCard/:id" render={(props)=> <MovieDesc {...props} list={ListM}/>}/>
        </Switch>
      </Router>
       {/* <Home /> */}
